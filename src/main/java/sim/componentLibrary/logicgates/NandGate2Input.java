 ...
 */
public class NandGate2Input extends Component {
     ...
     */
    public String getLongName() { return "Nand Gate with 2 Inputs"; }
    public String getShortName() { return "Nand 2 input"; }
