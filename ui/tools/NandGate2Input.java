...
public class NandGate2Input extends ImageSelectableComponent{
    ...
    protected void setDefaultImage() {
         try {
            defaultBi = ImageIO.read(new File("build/classes/ui/images/components/default_2in_nand.png"));
        } catch (IOException ex) {
            Logger.getLogger(NandGate2Input.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    protected void setSelectedImage() {
         try {
            selectedBi = ImageIO.read(new File("build/classes/ui/images/components/selected_2in_nand.png"));
        } catch (IOException ex) {
            Logger.getLogger(NandGate2Input.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    protected void setActiveImage() {
         try {
            activeBi = ImageIO.read(new File("build/classes/ui/images/components/active_2in_nand.png"));
        } catch (IOException ex) {
            Logger.getLogger(NandGate2Input.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
