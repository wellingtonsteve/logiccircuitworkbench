...
public class UIConstants {    
    ...
    public static final Color CIRCUIT_PLAYING_BACKGROUND_COLOUR = 
            new Color(242,255,255);
    public static final Color SUBCIRCUIT_BACKGROUND_COLOUR = 
    ...
    public static final Stroke SELECTION_BOX_STROKE = 
     ...
     *  LCW v2.0  -  Netlist support, Component names match keys in netlists.
     *               Not backwards compatible with v1.0
     *  LCW v2.1  -  As 2.0, "Standard.Wire" moved to "Wire", backwards 
     *               compatible with renaming of wire.
     *  LCW v3.0  -  Attributes use netlist properties, no more special cases, 
     *               not backwards compatible.
     *  LCW v3.1  -  As 3.0, with Orientation-Position pairs for dynamically 
     *               created components.*/
    ...
    /** Height of the graph (i.e. difference between high and low values)*/
    public static final int LOGGER_HEIGHT = 30; 
