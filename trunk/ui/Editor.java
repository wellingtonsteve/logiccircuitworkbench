 ...
 * @author  Matt
 */
public class Editor extends javax.swing.JFrame implements ErrorListener, OptionsPanel {
    ...
    private void initComponents() {
        ...
        OptionsScrollPane.setViewportBorder(javax.swing.BorderFactory.createEmptyBorder(1, 1, 1, 1));
            ...
            .add(optionsPanelLayout.createSequentialGroup()
                .add(optionsPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(optionsPanelLayout.createSequentialGroup()
                        ...
                        .add(labelTextbox, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE))
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, OptionsPane, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE)
                    .add(titleLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, typeLabel, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE)
                    .add(Preview, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 158, Short.MAX_VALUE))
                .addContainerGap())
        );
        optionsPanelLayout.setVerticalGroup(
            ...
            .add(optionsPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(Preview, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 119, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );

        OptionsScrollPane.setViewportView(optionsPanel);

        Toolbox.add(OptionsScrollPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 330, 170, 260));
        ...
        statusPanelLayout.setHorizontalGroup(
            ...
            .add(statusPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED, 763, Short.MAX_VALUE)
        ...
        for(Netlist nl: netlists){
            if(nl.containsLogicKey(key)){           
                try {
                    ...
                    ErrorHandler.newError("Editor Error","An error " +
                            "occured whilst trying to create a "+ key +
                            "\n dynamically from it's properties." +
                            " \n\n It is recommended that you create a concrete " +
                            "drawable implementation of this component.", e);
                }
                found = true;
            } 
        }        
        ...
        for(Netlist nl: netlists){
            if(nl.containsLogicKey(key)){
                try {
                    ...
                    ErrorHandler.newError("Editor Error",
                            "An error occured whilst trying to create a "+ key +
                            " logical component.", e);
                }
            }
        }
