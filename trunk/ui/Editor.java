...
// TODO add your handling code here:
    ...
    public void fixComponent(SelectableComponent sc) {
        getActiveCircuit().getCommandHistory().doCommand(
                new FixComponentCommand(getActiveCircuit().getCommandHistory(), sc));
    }
    ...
    private class ImageSelectableComponentImpl extends ImageSelectableComponent {
        ...
        protected void setLocalPins() {
            ...
            for (int i = 0; i < inputPinNo; i++) {
                Pin p = new Pin(0, (i + 1) * UIConstants.GRID_DOT_SPACING);
                localPins.add(p);
            }

            for (int i = 0; i < outputPinNo; i++) {
                Pin p = new Pin(getWidth() + UIConstants.GRID_DOT_SPACING, (i + 1) * UIConstants.GRID_DOT_SPACING);
                localPins.add(p);
            }
        }
