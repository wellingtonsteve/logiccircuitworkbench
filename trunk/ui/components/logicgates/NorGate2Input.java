 ...
 * @author Matt
 */
public class NorGate2Input extends VisualComponent{

    public NorGate2Input(ui.CircuitPanel parent, Point point, sim.SimItem simItem, netlist.properties.Properties properties) {
        super(parent, point, simItem,properties);
    }
    
    @Override
    protected void setKeyName() {
        keyName = "Logic Gates.2 Input.NOR";
    }
